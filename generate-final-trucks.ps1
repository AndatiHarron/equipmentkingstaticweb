# PowerShell script to generate truck pages from user data with proper encoding

# Parse JSON data directly from user input
$userJsonData = @'
{
  "trucks": {
    "LIGHT DUTY TRUCKS": {
          ...
          "models": [
            {
              ...
              "features": [
                "Power steering", "Clutch booster", "Electric windows", "Central lock", "Remote key", "Air conditioner", "ABS"
              ],
              "applications": [
                "Transportation", "Commercial logistics", "Urban cargo delivery"
              ]
            },
            {
              "name": "E9 Dump Truck",
              ...
              "features": [
                "High-strength chassis", "Airline seat", "Full steel cab", "Reinforced tyres"
              ],
              "applications": [
                "Commercial transport", "Construction logistics"
              ]
            }
          ]
        },
          ...
          "models": [
            {
              ...
              "features": [
                "Power steering", "Clutch booster", "Air conditioner", "ABS"
              ],
              "applications": [
                "Towing and recovery operations", "Municipal transport"
              ]
            },
            {
              ...
              "features": [
                "All-wheel drive", "Leaf-spring suspension", "High reliability", "Damped suspension"
              ],
              "applications": [
                "Construction transport", "All-terrain logistics"
              ]
            },
            {
              ...
              "features": [
                "Telescopic arms", "Fast lifting speed", "Safety protection systems"
              ],
              "applications": [
                "Aerial maintenance", "Utility services"
              ]
            }
          ]
        },
          ...
          "models": [
            {
              ...
              "features": [
                "Electric Power Steering", "Brake energy recovery", "Fast charging technology"
              ],
              "applications": [
                "Urban logistics", "Low-emission transport"
              ]
            }
          ]
        }
          ...
          "models": [
            {
              ...
              "features": [
                "Airbag seat", "Automatic AC", "LCD instrument panel"
              ],
              "applications": [
            ...
            },
            {
              ...
              "features": [
                "Oil-water separator", "Air Processing Unit", "Power steering", "ABS"
              ],
              "applications": [
                "Cargo logistics", "Urban transport"
              ]
            },
            {
              ...
              "features": [
                "Power steering", "Remote key", "Air conditioner", "ABS"
              ],
              "applications": [
                "Construction", "Heavy lifting logistics"
              ]
            }
          ]
        },
          ...
          "models": [
            {
              ...
              "features": [
                "Airbag seat", "Low-rolling tires", "Optimized transmission"
              ],
              "applications": [
                "Transport", "Construction delivery"
              ]
            },
            {
              ...
              "features": [
                "All-wheel drive", "High-strength chassis", "Durable suspension"
              ],
              "applications": [
                "Off-road cargo transport", "Heavy logistics"
              ]
            }
          ]
        }
          ...
          "models": [
            {
              ...
              "features": [
                "ABS, ESC, AEBS", "360° view system", "LCD display", "Heated air seat"
              ],
              "applications": [
                "Long-haul transport", "Heavy logistics"
              ]
            }
          ]
        },
          ...
          "models": [
            {
              ...
              "features": [
                "AEBS, ESC", "Blind spot monitoring", "Heated air seat", "LED lights"
              ],
              "applications": [
          ...
          "models": [
            {
              ...
              "features": [
                "Airbag seat", "Automatic AC", "LED headlights"
              ],
              "applications": [
                "Commercial logistics", "Freight delivery"
              ]
            },
            {
              ...
              "features": [
                "Airbag seat", "LED lights", "LCD instrument"
              ],
              "applications": [
                "Long-distance hauling", "Industrial logistics"
              ]
            }
          ]
        }
...
# Generate simple HTML files directly
        ...
        $series.models | ForEach-Object {
            ...
            if ($truck.specifications) {
                $truck.specifications.PSObject.Properties | ForEach-Object {
                    $specsRows += "                                        <tr><td><strong>$($_.Name)</strong></td><td>$($_.Value)</td></tr>`n"
                }
            }
            ...
            <section class="truck-hero">
                <div class="hero-container">
                    <div class="hero-image">
                        <img src="../assets/back2.jpeg" alt="$($truck.name)" class="truck-main-image">
                    </div>
